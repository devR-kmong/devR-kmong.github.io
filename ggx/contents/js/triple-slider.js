...
function createTripleSlider(el) {
  // main swiper el
  const swiperEl = el.querySelector('.a1Swiper');
  ...
  const swiperPrevSlides = swiperPrevEl.querySelectorAll('.swiper-slide2');
  ...
  const swiperNextSlides = swiperNextEl.querySelectorAll('.swiper-slide2');
