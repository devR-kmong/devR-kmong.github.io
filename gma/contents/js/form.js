...
$('.f-personal2').click(function () {
    if ($('#cb2').is(':checked')) {
        $('.ft-form .f-submit2').attr('disabled', false);
    } else {
        $('.ft-form .f-submit2').attr('disabled', true);
    }
})
...
$('.pc-closeBtn').click(function () {
    $('.floating').toggleClass('down');
})