...
$('.a7-personal-text').click(function () {
    if ($('#cb').is(':checked')) {
        $('.a7-personal').removeClass('a7-personal-no');
        $('.a7-personal-text label p').html('개인정보 수집 및 이용에 동의합니다.');
        $('.a7-form .a7-submit').attr('disabled', false);
    } else {
        $('.a7-personal').addClass('a7-personal-no');
        $('.a7-personal-text label p').html('개인정보처리방침에 동의해주세요.');
        $('.a7-form .a7-submit').attr('disabled', true);
    }
})
